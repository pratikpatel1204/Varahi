...
function reprintIdCard(id) {
    ...
    $.ajax({
        url: "<?php echo e(route('admin.id.cards.reprint')); ?>",
        type: "GET",
        data: { ids: [id] },
...
function deleteIdCard(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?php echo e(url('admin/id-cards/delete')); ?>/" + id,
                type: "POST",
...
$(document).ready(function () {
    ...
    let table = $('#idCardReportTable').DataTable({
        ...
        scrollX: true,
        ajax: {
            url: "<?php echo e(route('admin.id.cards.ajaxWith')); ?>",
            type: "POST",
            data: function (d) {
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Varahi\resources\views/admin/id_cards/report.blade.php ENDPATH**/ ?>