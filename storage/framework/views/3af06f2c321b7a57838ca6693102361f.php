...
<div class="content">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('admin.id.card.template.index')); ?>" class="btn btn-secondary btn-sm">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.id.card.template.update', $template->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="d-flex flex-wrap gap-1 mt-1">
                            ...
                            ?>
                            <?php $__currentLoopData = $companyPlaceholders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="badge border"
                                  style="cursor:pointer;font-size:12px;padding:6px 10px;
                                         background:#fff3e0;color:#e65100;border-color:#ffcc80 !important;"
                                  onclick="insertPlaceholder('<?php echo e($key); ?>')"
                                  title="<?php echo e($key); ?>">
                                <i class="ti ti-building me-1" style="font-size:10px;"></i><?php echo e($label); ?>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="d-flex flex-wrap gap-1 mt-1">
                            ...
                            ?>
                            <?php $__currentLoopData = $employeePlaceholders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="badge border"
                                  style="cursor:pointer;font-size:12px;padding:6px 10px;
                                         background:#e8f0fe;color:#1a3c5e;border-color:#b0c8f0 !important;"
                                  onclick="insertPlaceholder('<?php echo e($key); ?>')"
                                  title="<?php echo e($key); ?>">
                                <i class="ti ti-user me-1" style="font-size:10px;"></i><?php echo e($label); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="previewEmployee" class="form-select form-select-sm">
                                    ...
                                    <option value="<?php echo e($emp->id); ?>"
                                        ...
                                        data-code="<?php echo e($emp->employee_code); ?>"
                                        data-email="<?php echo e($emp->email); ?>"
                                        data-phone="<?php echo e($emp->phone); ?>"
                                        data-gender="<?php echo e($emp->gender); ?>"
                                        data-dob="<?php echo e($emp->dob); ?>"
                                        data-joining="<?php echo e($emp->joining_date); ?>"
                                        data-designation="<?php echo e(optional($emp->designation)->name); ?>"
                                        data-department="<?php echo e(optional($emp->department)->name); ?>"
                                        data-site="<?php echo e($sites->company_name); ?>"
                                        data-blood-group="<?php echo e(optional($emp->bloodGroup)->name); ?>"
                                        data-emergency-phone1="<?php echo e($emp->emergency_phone_1); ?>"
                                        data-profile-image="<?php echo e($emp->profile_image ? asset( $emp->profile_image) : ''); ?>"
                                        data-company-name="<?php echo e($sites->company_name); ?>"
                                        data-company-phone="<?php echo e($sites->phone); ?>"
                                        data-company-address="<?php echo e($sites->address); ?>"
                                        data-company-logo="<?php echo e(asset($sites->company_logo) ?? ''); ?>">
                                        <?php echo e($emp->employee_code); ?> - <?php echo e($emp->name); ?>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="content" id="templateContent" class="form-control"
                              rows="25"
                              style="font-family:monospace; font-size:13px;"><?php echo e(old('content', $template->content)); ?></textarea>
                </div>
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Varahi\resources\views/admin/id_cards/template_edit.blade.php ENDPATH**/ ?>